...
const App = () => {
  return (
    <Router>
      <Routes>
        <Route exact path="/" element={<><Header/><Body/><About/></>}/>
        <Route exact path="/AboutUs" element={<><Header/><AboutUs/></>}/>

        <Route exact path="/Excom" element={<><Header/><Excom19/><Excom20/><Excom21/></>}/>
        <Route exact path="/Societies" element={<><Header/><Society/></>}/>

        <Route exact path="/Events" element={<><Header/><Events20/><Events21/><Events22/></>}/>
        <Route exact path="/Membership" element={<><Header/><Membership/></>}/>

        <Route exact path="/Gallery" element={<><Header/></>}/>
        <Route exact path="/ContactUs" element={<><Header/><Contact/></>}/>
        <Route exact path="/SignIn" element={<><Header/><SignIn/></>}/>
